...
KC_PUBLIC void type_check(KC_session *session);
KC_PUBLIC bool type_equiv(KCType *t, KCType *u);
KC_PUBLIC bool unify(KCType *t, KCType *u);
...
KC_PUBLIC KCType *resolve_type(KCType *type);
...
KC_PUBLIC struct type_spec *lookup_poly_proc_spec(struct definition *def, KCType *t);
KC_PUBLIC KCType *type_slice_to_array_ptr(KCType *t);
KC_PUBLIC struct struct_type *struct_type_members(KCType *type);
...
KC_PUBLIC bool type_is_struct(KCType *t);
KC_PUBLIC bool type_is_struct_ptr(KCType *t);
KC_PUBLIC bool type_is_union(KCType *t);
KC_PUBLIC bool type_is_union_ptr(KCType *t);
